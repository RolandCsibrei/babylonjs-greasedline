...
export function dash(scene: Scene, camera: ArcRotateCamera) {
  ...
  const ls1 = GreasedLineBuilder.CreateGreasedLine(
    'dashed-1',
    {
      points: line,
    },
  ...
  const ls2 = GreasedLineBuilder.CreateGreasedLine(
    'dashed-2',
    {
      points: line,
    },
  ...
  const ls3 = GreasedLineBuilder.CreateGreasedLine(
    'dashed-3',
    {
      points: line,
    },
  ...
  const ls4 = GreasedLineBuilder.CreateGreasedLine(
    'dashed-3',
    {
      points: line,
    },
  ...
  const ls5 = GreasedLineBuilder.CreateGreasedLine(
    'dashed-animated-1',
    {
      points: line,
    },
