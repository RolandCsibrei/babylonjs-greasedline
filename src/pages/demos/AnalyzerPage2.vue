...
import { Analyser, ArcRotateCamera, Color3, Engine, RawTexture, Scene, Sound, StandardMaterial, Vector2, Vector3 } from '@babylonjs/core';
...
const demo = (scene: Scene, camera: ArcRotateCamera) => {
  ...
  let material = analyzerLine.material as StandardMaterial
  ...
  // material = waveLine.material as StandardMaterial
  // material.disableLighting = true
