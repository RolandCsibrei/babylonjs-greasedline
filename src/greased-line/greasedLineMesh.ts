...
export class GreasedLineMesh extends Mesh {
  public static readonly COLOR_DISTRIBUTION_NONE = 0;
  public static readonly COLOR_DISTRIBUTION_REPEAT = 1;
  public static readonly COLOR_DISTRIBUTION_EVEN = 2;
  public static readonly COLOR_DISTRIBUTION_START = 3;
  public static readonly COLOR_DISTRIBUTION_END = 4;
  public static readonly COLOR_DISTRIBUTION_START_END = 5;

  public static readonly WIDTH_DISTRIBUTION_NONE = 0;
  public static readonly WIDTH_DISTRIBUTION_REPEAT = 1;
  public static readonly WIDTH_DISTRIBUTION_EVEN = 2;
  public static readonly WIDTH_DISTRIBUTION_START = 3;
  public static readonly WIDTH_DISTRIBUTION_END = 4;
  public static readonly WIDTH_DISTRIBUTION_START_END = 5;

  public static readonly MATERIAL_TYPE_SIMPLE = 0;
